...
export class mxsParserVisitorFormatter extends mxsParserVisitor<string>
{
    ...
    */
    ...
    visitLp = (ctx: LpContext): string => '('
    visitRp = (ctx: RpContext): string => ')'
    visitLc = (ctx: LcContext): string => '{'
    visitRc = (ctx: RcContext): string => '}'
    visitLb = (ctx: LbContext): string => '['
    visitRb = (ctx: RbContext): string => ']'
    visitComma = (ctx: CommaContext): string => ','
    //-------------------------------------------------------
    visitLbk = (ctx: LbkContext): string => { return options.newLineChar }
